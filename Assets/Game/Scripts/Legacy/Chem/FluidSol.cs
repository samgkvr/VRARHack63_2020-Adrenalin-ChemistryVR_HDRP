...
/// </summary>
public class FluidSol: ScriptableObject{
    ...
    /// </summary>
    /// <param name="WaterSource">The other solution to be added to this one.</param>
    ...
    public FluidSol(FluidSol other)
    {
        //Set temperature.
    ...
    /// </summary>
    /// <param name="other"></param>
    public void init(FluidSol other)
    {
        //Set temperature.
        this.temperature = other.temperature;
